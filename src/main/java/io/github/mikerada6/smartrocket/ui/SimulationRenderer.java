...
public final class SimulationRenderer {
    ...
    private static void drawLaunch(Graphics2D g, Vec2 launch) {
        ...
        g.setColor(LAUNCH);
        g.drawRect(x, y, World.ROCKET_WIDTH, World.ROCKET_HEIGHT);
        int cx = x + World.ROCKET_WIDTH / 2;
    ...
    private static void drawRocket(Graphics2D g, Rocket rocket, World world) {
        ...
        double cx = pos.x() + World.ROCKET_WIDTH / 2.0;
        double cy = pos.y() + World.ROCKET_HEIGHT / 2.0;
        ...
        g.fillRect((int) pos.x(), (int) pos.y(), World.ROCKET_WIDTH, World.ROCKET_HEIGHT);
        if (rocket.isElite()) {
            g.setColor(ELITE_OUTLINE);
            g.drawRect((int) pos.x() - 1, (int) pos.y() - 1, World.ROCKET_WIDTH + 1, World.ROCKET_HEIGHT + 1);
        }
        g.setTransform(old);
    }
    ...
    private static void drawTrail(Graphics2D g, Rocket rocket) {
        ...
        for (int i = 1; i < trail.size(); i++) {
            ...
            Vec2 b = trail.get(i);
            g.drawLine((int) (a.x() + World.ROCKET_WIDTH / 2.0), (int) (a.y() + World.ROCKET_HEIGHT / 2.0),
                    (int) (b.x() + World.ROCKET_WIDTH / 2.0), (int) (b.y() + World.ROCKET_HEIGHT / 2.0));
        }
